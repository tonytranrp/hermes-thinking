...
def main():
    ...
    if args.signals < args.states:
        ...
        print("that didn't exist in the world. The compression is ARBITRARY, not iconic:")
        print("adjacent states don't preferentially merge. Instead, the merge pattern")
        print("is shaped by path dependence — the first few successful compressions")
        print("lock in, creating ruts that shape all future interactions.")
        print("The bottleneck CREATES abstraction, but the abstractions are contingent.")
        print()
